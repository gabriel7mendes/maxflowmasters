...
public class RandomFordFulkersonEmaApp1 {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * int s = 0; int t = 5; int m = 10;
		 * 
		 * RandomFordFulkersonEma randomFordFulkersonEma = new RandomFordFulkersonEma(m
		 * - 1);
		 * 
		 * randomFordFulkersonEma.addEdge(s, 1, 16); randomFordFulkersonEma.addEdge(s,
		 * 2, 13); randomFordFulkersonEma.addEdge(1, 2, 10);
		 * randomFordFulkersonEma.addEdge(2, 1, 4); randomFordFulkersonEma.addEdge(1, 3,
		 * 12); randomFordFulkersonEma.addEdge(2, 4, 14);
		 * randomFordFulkersonEma.addEdge(3, 2, 9); randomFordFulkersonEma.addEdge(3, t,
		 * 20); randomFordFulkersonEma.addEdge(4, 3, 7);
